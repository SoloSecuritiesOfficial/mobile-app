...
export const getCertificates = async () => {
  try {
    const response = await api.get("/security/certificates");
...
export const getCertificateById = async (id: string) => {
  try {
    const response = await api.get(`/security/certificates/${id}`);
...
export const issueCertificate = async (data: {
  ...
  try {
    const response = await api.post("/security/certificates/issue", data);
...
export const getCertificateCount = async () => {
  try {
    const response = await api.get("/security/certificates/count");
